...
Ταυτόχρονα, στα τέλη του 2007 επιστήμονες από το πανεπιστήμιο του ΜΙΤ, παρουσίασαν μια εργασία στην οποία απέδειξαν αναλυτικά οτι είναι δυνατό να επιτευχθεί ασύρματη
...
συνέχεια, ορίζεται αυστηρώς το πρόβλημα του κινητού φορτιστή και αποδεικνύεται οτι είναι NP-πλήρης (NP-complete). Για να υπάρχει καλύτερη σύγκριση στην επίδρασης που
έχει η ενσωμάτωση του κινητού φορτιστή στα συστήματα ΑΔΑ, θεωρείται οτι η συνολική αρχική
