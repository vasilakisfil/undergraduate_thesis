...
Αφού το δίκτυο είναι αρκετά πυκνό, θεωρείται ότι κάθε μετάδοση κοστίζει $r^{2}$ σε μονάδες ενέργειας, όπου $r$ είναι ακτίνα μετάδοσης ενός κόμβου. Αφού οι κόμβοι
...
Στην πειραματική αξιολόγηση ερευνώνται οι στρατηγικές που μελετήθηκαν στο κεφάλαιο \ref{ch:strategies_solution} ώστε να βρεθεί η βέλτιστη στρατηγική και οι
...
\begin{figure}[H]
  ...
  \caption{Συνδεσιμότητα κατά την πάροδο του χρόνου. Η συνεχόμενη γραμμή αντιστοιχεί στο δίκτυο με κινητό φορτιστή. Υπάρχει σημαντική αύξηση της συνδεσιμότητας του
...
\begin{figure}[H]
  ...
  \caption{Κάλυψη του δικτύου κατά την πάροδο του χρόνου για το πρωτόκολλο Leach. Είναι εμφανές ότι η στρατηγική της μερικής φόρτισης έχει καλύτερα αποτελέσματα.}
  \label{fig:2exp_3_2}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Κάλυψη του δικτύου κατά την πάροδο του χρόνου για το πρωτόκολλο $\text{E}_{i}$. Είναι εμφανές ότι η στρατηγική της μερικής φόρτισης έχει καλύτερα
αποτελέσματα.}
  \label{fig:2exp_3_3}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Κάλυψη του δικτύου κατά την πάροδο του χρόνου για το πρωτόκολλο Greedy. Χρησιμοποιείται μερική φόρτιση και έχει δοθεί το 20\% της ενέργειας στον φορτιστή.}
  \label{fig:4exp_2_1}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Κάλυψη του δικτύου κατά την πάροδο του χρόνου για το πρωτόκολλο Leach. Χρησιμοποιείται μερική φόρτιση και έχει δοθεί το 20\% της ενέργειας στον φορτιστή.}
  \label{fig:4exp_2_2}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Κάλυψη του δικτύου κατά την πάροδο του χρόνου για το πρωτόκολλο $\text{E}_{i}$. Χρησιμοποιείται μερική φόρτιση και έχει
δοθεί το 20\% της ενέργειας στον φορτιστή.}
  \label{fig:4exp_2_3}
\end{figure}


\section{Παραμετροποιώντας την Τεχνολογία Φόρτισης}\label{sc:result5}
...
\begin{figure}[H]
  \centering
  \subfloat[Greedy με $E^{init}_{MC}=20\%$]{\includegraphics[width=0.48\textwidth]{experiments/classic/5.smallVSbigtech/0.2/alive_nodes_greedy_rc_per_our.eps}}
  \subfloat[Greedy με $E^{init}_{MC}=40\%$]{\includegraphics[width=0.48\textwidth]{experiments/classic/5.smallVSbigtech/0.4/alive_nodes_greedy_rc_per_our.eps}}
  \subfloat[Greedy με $E^{init}_{MC}=60\%$]{\includegraphics[width=0.48\textwidth]{experiments/classic/5.smallVSbigtech/0.6/alive_nodes_greedy_rc_per_our.eps}}
  \subfloat[Greedy με $E^{init}_{MC}=80\%$]{\includegraphics[width=0.48\textwidth]{experiments/classic/5.smallVSbigtech/0.8/alive_nodes_greedy_rc_per_our.eps}}
...
\begin{figure}[H]
  \centering
  \subfloat[Leach με $E^{init}_{MC}=20\%$]{\includegraphics[width=0.48\textwidth]{experiments/classic/5.smallVSbigtech/0.2/alive_nodes_leach_rc_per_our.eps}}
  \subfloat[Leach με $E^{init}_{MC}=40\%$]{\includegraphics[width=0.48\textwidth]{experiments/classic/5.smallVSbigtech/0.4/alive_nodes_leach_rc_per_our.eps}}
  \subfloat[Leach με $E^{init}_{MC}=60\%$]{\includegraphics[width=0.48\textwidth]{experiments/classic/5.smallVSbigtech/0.6/alive_nodes_leach_rc_per_our.eps}}
  \subfloat[Leach με $E^{init}_{MC}=80\%$]{\includegraphics[width=0.48\textwidth]{experiments/classic/5.smallVSbigtech/0.8/alive_nodes_leach_rc_per_our.eps}}
...
\begin{figure}[H]
  \centering
  \subfloat[$\text{E}_{i}$ με $E^{init}_{MC}=20\%$]{\includegraphics[width=0.48\textwidth]{experiments/classic/5.smallVSbigtech/0.2/alive_nodes_ei_rc_per_our.eps}}
  \subfloat[$\text{E}_{i}$ με $E^{init}_{MC}=40\%$]{\includegraphics[width=0.48\textwidth]{experiments/classic/5.smallVSbigtech/0.4/alive_nodes_ei_rc_per_our.eps}}
  \subfloat[$\text{E}_{i}$ με $E^{init}_{MC}=60\%$]{\includegraphics[width=0.48\textwidth]{experiments/classic/5.smallVSbigtech/0.6/alive_nodes_ei_rc_per_our.eps}}
  \subfloat[$\text{E}_{i}$ με $E^{init}_{MC}=80\%$]{\includegraphics[width=0.48\textwidth]{experiments/classic/5.smallVSbigtech/0.8/alive_nodes_ei_rc_per_our.eps}}
...
\subsection{Με και Χωρίς Φόρτιση}\label{subc:result6_1}
%%%%%%%%%%%%%%%%%%%%%%%%%%%% 1. LIFETIME %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[H]
  \centering
...
\subsection{Ολική και Μερική Φόρτιση}\label{subc:result6_2}
%%%%%%%%%%%%%%%%%%%%%%%%%%%% 1. LIFETIME %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[H]
  \centering
...
\begin{figure}[H]
  ...
  \caption{Κάλυψη του δικτύου κατά την πάροδο του χρόνου για το πρωτόκολλο Leach. Δεν είναι εμφανές ποια στρατηγική έχει καλύτερα λόγω του μεγάλου αριθμού κόμβων.}
...
\begin{figure}[H]
  ...
  \caption{Κάλυψη του δικτύου κατά την πάροδο του χρόνου για το πρωτόκολλο $\text{E}_{i}$. Δεν είναι εμφανές ποια στρατηγική έχει καλύτερα λόγω του μεγάλου αριθμού
κόμβων.}
  \label{fig:5_2exp_3_3}
\end{figure}


\subsection{Ποσοστό Ενέργειας στον Φορτιστή}\label{subc:result6_3}
%%%%%%%%%%%%%%%%%%%%%%%%%%%% 1. LIFETIME %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[H]
  \centering
...
\subsection{Παραμετροποιώντας την Τεχνολογία Φόρτισης}\label{subc:result6_5}

%%%%%%%%%%%%%%%%%%%%%%%%%%%% 1. LIFETIME %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{figure}[H]
  \centering
  \subfloat[Greedy με $E^{init}_{MC}=20\%$]{\includegraphics[width=0.48\textwidth]{experiments/4000nodes/5.smallVSbigtech/0.2/alive_nodes_greedy_rc_per_our.eps}}
  \subfloat[Greedy με $E^{init}_{MC}=40\%$]{\includegraphics[width=0.48\textwidth]{experiments/4000nodes/5.smallVSbigtech/0.4/alive_nodes_greedy_rc_per_our.eps}}
  \subfloat[Greedy με $E^{init}_{MC}=60\%$]{\includegraphics[width=0.48\textwidth]{experiments/4000nodes/5.smallVSbigtech/0.6/alive_nodes_greedy_rc_per_our.eps}}
  \subfloat[Greedy με $E^{init}_{MC}=80\%$]{\includegraphics[width=0.48\textwidth]{experiments/4000nodes/5.smallVSbigtech/0.8/alive_nodes_greedy_rc_per_our.eps}}
  \caption{Ζωντανοί κόμβοι κατά την πάροδο του χρόνου για το Greedy πρωτόκολλο για διάφορες αποδόσεις της τεχνολογίας (αναλογία του αριθμού των κόμβων που φορτίζει
ο φορτιστής ως προς τον αριθμό των μηνυμάτων που δημιουργούνται στο ίδιο χρονικό διάστημα στο δίκτυο) και για διάφορα ποσοστά αρχικής ενέργειας που δίνονται στον
κινητό φορτιστή. Από τις εικόνες φαίνεται ότι θα πρέπει να υπάρχει κατάλληλη τεχνολογία ώστε ο φορτιστής να μπορεί να φορτίζει τουλάχιστον 3 κόμβους ανά ένα
...
\begin{figure}[H]
  \centering
  \subfloat[Leach με $E^{init}_{MC}=20\%$]{\includegraphics[width=0.48\textwidth]{experiments/4000nodes/5.smallVSbigtech/0.2/alive_nodes_leach_rc_per_our.eps}}
  \subfloat[Leach με $E^{init}_{MC}=40\%$]{\includegraphics[width=0.48\textwidth]{experiments/4000nodes/5.smallVSbigtech/0.4/alive_nodes_leach_rc_per_our.eps}}
  \subfloat[Leach με $E^{init}_{MC}=60\%$]{\includegraphics[width=0.48\textwidth]{experiments/4000nodes/5.smallVSbigtech/0.6/alive_nodes_leach_rc_per_our.eps}}
  \subfloat[Leach με $E^{init}_{MC}=80\%$]{\includegraphics[width=0.48\textwidth]{experiments/4000nodes/5.smallVSbigtech/0.8/alive_nodes_leach_rc_per_our.eps}}
  \caption{Ζωντανοί κόμβοι κατά την πάροδο του χρόνου για το Leach πρωτόκολλο για διάφορες αποδόσεις της τεχνολογίας (αναλογία του αριθμού των κόμβων που φορτίζει
ο φορτιστής ως προς τον αριθμό των μηνυμάτων που δημιουργούνται στο ίδιο χρονικό διάστημα στο δίκτυο) και για διάφορα ποσοστά αρχικής ενέργειας που δίνονται στον
κινητό φορτιστή. Από τις εικόνες φαίνεται ότι θα πρέπει να υπάρχει κατάλληλη τεχνολογία ώστε ο φορτιστής να μπορεί να φορτίζει τουλάχιστον 3 κόμβους ανά ένα
καινούργιο μήνυμα που απαιτεί πολυ βηματική δρομολόγηση.}
...
\begin{figure}[H]
  \centering
  \subfloat[$\text{E}_{i}$ με $E^{init}_{MC}=20\%$]{\includegraphics[width=0.48\textwidth]{experiments/4000nodes/5.smallVSbigtech/0.2/alive_nodes_ei_rc_per_our.eps}}
  \subfloat[$\text{E}_{i}$ με $E^{init}_{MC}=40\%$]{\includegraphics[width=0.48\textwidth]{experiments/4000nodes/5.smallVSbigtech/0.4/alive_nodes_ei_rc_per_our.eps}}
  \subfloat[$\text{E}_{i}$ με $E^{init}_{MC}=60\%$]{\includegraphics[width=0.48\textwidth]{experiments/4000nodes/5.smallVSbigtech/0.6/alive_nodes_ei_rc_per_our.eps}}
  \subfloat[$\text{E}_{i}$ με $E^{init}_{MC}=80\%$]{\includegraphics[width=0.48\textwidth]{experiments/4000nodes/5.smallVSbigtech/0.8/alive_nodes_ei_rc_per_our.eps}}
  \caption{Ζωντανοί κόμβοι κατά την πάροδο του χρόνου για το $\text{E}_{i}$ πρωτόκολλο για διάφορες αποδόσεις της τεχνολογίας (αναλογία του αριθμού των κόμβων που
φορτίζει ο φορτιστής ως προς τον αριθμό των μηνυμάτων που δημιουργούνται στο ίδιο χρονικό διάστημα στο δίκτυο) και για διάφορα ποσοστά αρχικής ενέργειας που δίνονται
στον κινητό φορτιστή. Από τις εικόνες φαίνεται ότι θα πρέπει να υπάρχει κατάλληλη τεχνολογία ώστε ο φορτιστής να μπορεί να φορτίζει τουλάχιστον 3 κόμβους ανά ένα
καινούργιο μήνυμα που απαιτεί πολυ βηματική δρομολόγηση.}
